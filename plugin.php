        ...
        private static function check_site()
        {
            ...
            if($siteUrl) {
                if(strpos($_SERVER['HTTP_HOST'], 'localhost') === false && $_SERVER['REMOTE_ADDR'] != '127.0.0.1' && !preg_match("/192\.168\.[0-9]{1,3}\.[0-9]{1,3}/i", $_SERVER['REMOTE_ADDR']) && !preg_match("/172.\.16\.[0-9]{1,3}\.[0-9]{1,3}/i", $_SERVER['REMOTE_ADDR']) 
                          && !preg_match("/172\.(16|17|18|19)\.[0-9]{1,3}\.[0-9]{1,3}/i", $_SERVER['REMOTE_ADDR']) && !preg_match("/10.\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}/i", $_SERVER['REMOTE_ADDR'])) {
        ...
        public static function notices()
        {
            ...
            if($siteUrl) {
                if(strpos($_SERVER['HTTP_HOST'], 'localhost') === false && $_SERVER['REMOTE_ADDR'] != '127.0.0.1' 
                   && !preg_match("/192\.168\.[0-9]{1,3}\.[0-9]{1,3}/i", $_SERVER['REMOTE_ADDR']) && !preg_match("/172\.(16|17|18|19)\.[0-9]{1,3}\.[0-9]{1,3}/i", $_SERVER['REMOTE_ADDR'])
