<?php
    ...
    */
    ...
    Description: Plugin for www.free-counter.org
    Version: 1.0.2
    */
    ...
    <table class="image_counter_table">
        ...
        <tr>
            <?php $temp = 1;
                ...
                <td>
                    <div class="img-block">
                        <div class="img-counter" type-counter="<?php echo $value['type']?>" id="<?php echo  $this->get_field_id( 'counter_' . $value['type'] );?>" onclick="saveImage(this,'<?php echo $this->get_field_id( 'counter_hidden' ); ?>','<?php echo $this->get_field_id( 'counter_type' ); ?>')">
                ...
                if ($instance['default_hidden'] == 2) {
                    echo '<script type="text/javascript">';
                    echo 'set_default_image("' . $this->get_field_id( 'counter_hidden_show' ) . '", "img-counter-active");';
                    echo ' </script>';
                } elseif ($instance['default_image'] == 0) {
                    echo '<script type="text/javascript">';
                    echo 'set_default_image("' . $this->get_field_id( 'counter_color' ) . '", "img-counter-active" );';
                    echo ' </script>';
                }   
            ...
            <td> 
                <div class="img-block">
                    <div class="img-counter" type-counter="hidden" onclick="saveImage(this, '<?php echo $this->get_field_id( 'counter_hidden' ); ?>','<?php echo $this->get_field_id( 'counter_type' ); ?>')" id="<?php echo $this->get_field_id( 'counter_hidden_show' ); ?>">
